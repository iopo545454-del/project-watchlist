...
| WLD unlock rate decreases by 43% | Confirmed / upcoming | World Foundation's reminder and official tokenomics post confirm the existing schedule: https://x.com/worldcoinfnd/status/2079972684260147258 and https://world.org/blog/foundational-topics/tokenomics-milestone-wld-unlock-rate-to-decrease-by-43-in-july. Aggregate unlocks fall from about `5.1M` to `2.9M WLD/day`; Community falls `3.2M`→`1.6M`, and TFH investor/team falls `1.9M`→`1.3M`. | 2026-07-24 / confirmed; linear daily unlocks continue with no cliff | Directly reduces the scheduled rate at which WLD becomes unlocked across all allocations. | Lower incremental supply can reduce market overhang, but unlocked is not identical to circulating or sold supply and OTC/treasury behavior still matters. | Verify the July 24 onchain schedule transition and reconcile unlocked versus circulating WLD, Foundation/TFH wallets, OTC sales and bridge flows. |
