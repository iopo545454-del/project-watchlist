...
| World Chain multi-proof validity verifier and proof-system hardening | Confirmed merged prior work; open follow-up implementation | Official GitHub merged an SP1 validity-proof verifier and removed an unused Nitro aggregation path: https://github.com/worldcoin/world-chain/pull/842 and https://github.com/worldcoin/world-chain/pull/845. Open PR #909 would require explicit L1-origin metadata and a valid proof at game creation: https://github.com/worldcoin/world-chain/pull/909 | Prior changes merged 2026-07-13; PR #909 opened 2026-07-23 and remains unmerged | Adds verifier diversity, removes a security-sensitive dead path and proposes fail-closed proof-game creation. | Hardening can reduce future proof-system attack surface, but downstream proposer changes, audits and deployed versions remain unresolved. | Verify PR #909 review/merge, proposer-binding follow-up, tests/audits, deployed contract/code versions, prior-path exposure, proof costs and live usage. |
...
- Verify whether World Chain's SP1 validity verifier is deployed/active, what audits cover the multi-proof system, whether the removed Nitro aggregation-signing path was ever callable in production, and whether PR #909 plus required proposer-binding changes merge and deploy.
...
|---|---|---|---|---|---|---|---|
| 2026-07-23 | World Chain may make proof-game creation fail closed by requiring explicit L1-origin metadata and a valid initial proof; invalid/empty proofs would revert atomically. | https://github.com/worldcoin/world-chain/pull/909 | Official GitHub implementation PR | High | Partially supported / open and unmerged | Changes a core proof-system entrypoint and can remove malformed/empty game creation, but it is not a disclosed exploit or deployed protection. | Check human review, merge, required proposer/bindings follow-up, tests/audit and deployed contract/code version; `carried_from: watchlist-scan-20260723T131204Z` |
