...
last_updated: 2026-07-14T11:18:54Z
---
...
|---|---|---|---|---|---|---|
| WIP-1008 WLD-staked subblocks and unsafe-head BFT | Tentative / watch — first approval, still open | World Chain PR #850 proposes WLD-staked validators, four-validator subblock committees, two-thirds-stake BFT attestations, slashing, priority-fee and attestation rewards, and a new attested head: https://github.com/worldcoin/world-chain/pull/850. First human approval, with a cost/benefit caveat: https://github.com/worldcoin/world-chain/pull/850#pullrequestreview-4691755012 | Opened 2026-07-13; first approval 2026-07-14; no merge or activation schedule | Would create protocol-native WLD staking and share block-revenue/reward flows with validators while adding accountable pre-L1-finality security and multi-party transaction inclusion. | If adopted, WLD gains productive utility and World Chain reduces single-sequencer censorship/reorg risk; validator concentration, emissions/reward funding and slashing design could also create new governance and market-structure risks. | Watch additional reviews/merge, Foundation/World Chain endorsement, whether the 3–4 minute unsafe window justifies the work, minimum stake, active-set/reward/slashing parameters, contracts/sidecar code, audits, testnet and governance/activation plan. |
...
|---|---|---|---|---|---|---|---|
| 2026-07-13 | WIP-1008 may add a WLD-staked validator overlay, protocol-guaranteed subblocks, BFT attestations, slashing, and validator fee/reward flows to World Chain. | https://github.com/worldcoin/world-chain/pull/850 | Official GitHub PR | High | Partially supported — ready for review with one approval; open/unmerged | This would be a step change in WLD utility, World Chain decentralization, censorship resistance and block-revenue distribution if adopted. A reviewer approved the design but questioned whether the work is worthwhile given the existing 3–4 minute unsafe-to-safe window. | `carried_from: scan-20260713T213409Z` — re-check additional reviews/merge, official Foundation/World Chain endorsement, cost/benefit decision, parameter commits, implementation code, audits, testnet and governance/activation evidence. |
