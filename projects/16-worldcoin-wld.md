...
last_updated: 2026-07-26T09:44:52Z
---
...
- 2026-07-26 — Dedicated verification closed World Chain **PR #909 as stale/event-driven, not shipped**. The branch now has one human approval and passing Foundry/static-analysis checks, but remains open and unmerged at `806c2dd`; one review thread still questions the externally exposed initial-proof lane, canonical proposer bindings still call the old three-argument `propose(...)`, and prerequisite PR #913 is also open. Draft PR #916 proposes an OP-native factory pivot that explicitly keeps optimistic game creation without an initial proof, so it conflicts with #909's fail-closed design. The contracts README says the code is unaudited/not production-ready, GitHub exposes no deployment for the branch SHA, and release `v2.4.0` predates it. Reopen only on a merged successor with proposer/binding integration, passed audit/CI and a versioned deployment. Sources: https://github.com/worldcoin/world-chain/pull/909, https://github.com/worldcoin/world-chain/pull/913, https://github.com/worldcoin/world-chain/pull/916 and https://github.com/worldcoin/world-chain/blob/806c2dd74944887044689b43c25c5d49299d46fd/pkg/contracts/README.md
- 2026-07-24 — The scheduled **WLD unlock-rate reduction executed onchain**. World’s official schedule moved aggregate unlocks from about `5.1M` to `2.9M WLD/day`: Community `3.2M`→`1.6M`, and TFH investor/team `1.9M`→`1.3M`. Direct Ethereum calls independently reproduce the Community leg: vesting wallet `0x1770…C296` reached its `3.5B WLD` end at `2026-07-24T00:00:00Z`, while `0xaEE0…0e57` began the next tranche at the same second; aggregate Community vesting was `3,193,430.66 WLD` in the preceding 24 hours and the new contract projects `1,596,715.33 WLD` over the next 24 hours. This verifies the scheduled entitlement rate, not automatic selling or circulation—vesting/releasable balances can accrue without a same-day token transfer, and the TFH `1.3M/day` leg remains schedule-backed rather than transaction-flow-attributed. Sources: https://world.org/blog/foundational-topics/tokenomics-milestone-wld-unlock-rate-to-decrease-by-43-in-july, https://etherscan.io/address/0x1770bd8186AAd27Df9B050D65f86CF2cdC92C296 and https://etherscan.io/address/0xaEE0360b73B5D01dad134f234d3a93adc1680e57
- 2026-07-23 — Dedicated SEC verification found **no amendment, effectiveness notice or second accession** for the proposed Grayscale Worldcoin ETF. The registrant's SEC submissions feed still contains only the 2026-07-20 S-1 (`0001193125-26-308957`); the filing's delaying amendment remains operative, fee/seed/AP terms remain incomplete and Nasdaq trading still depends on WLD satisfying Rule 5711(d)(iv) plus Nasdaq confirmation. The recurring follow-up is closed stale rather than carried every scan; reopen automatically when SEC CIK `0002145351`, Nasdaq or Grayscale publishes a new primary artifact. Sources: https://data.sec.gov/submissions/CIK0002145351.json and https://www.sec.gov/Archives/edgar/data/2145351/000119312526308957/ck0002145351-20260720.htm
- 2026-07-23 — World published a production-like **World ID Sandbox** developer environment and end-to-end Selfie Check test guide. Merged docs PRs #141/#142 describe resettable accounts, isolated backends and World ID app builds, a valid IDKit destination, public iOS TestFlight access and Android access through a World contact. The docs explicitly exclude load testing, security certification and production sign-off; this improves integration testing but adds no adoption or WLD value route. Sources: https://github.com/worldcoin/developer-docs/pull/141, https://github.com/worldcoin/developer-docs/pull/142 and https://docs.world.org/world-id/sandbox/what-is-sandbox
- 2026-07-23 — World Chain opened high-risk proof-system PR #909, requiring explicit L1-origin metadata and a valid proof when a proof game is created; invalid/empty proofs would atomically revert game creation. The PR changes the proposal entrypoint and initial-proof lane, but is **open, unmerged and incomplete** because proposer bindings still need adjustment. Treat this as a credible implementation/hardening signal, not a disclosed exploit or deployed fix. Source: https://github.com/worldcoin/world-chain/pull/909
- 2026-07-22 — World Foundation issued a final reminder that the scheduled **WLD unlock-rate reduction takes effect July 24, 2026**. The official April tokenomics post makes the market-structure change precise: aggregate daily unlocks fall **43%**, from about **`5.1M WLD/day` to `2.9M WLD/day`**. Community-token unlocks halve from `3.2M` to `1.6M WLD/day` under immutable onchain contracts, while TFH investor/team unlocks fall 32% from `1.9M` to `1.3M`. This is not a new schedule or cliff—the repo already tracked a July reduction—but it upgrades the catalyst from month-level timing to a confirmed date and quantified allocation split. Unlocks remain linear and daily. Sources: https://x.com/worldcoinfnd/status/2079972684260147258 and https://world.org/blog/foundational-topics/tokenomics-milestone-wld-unlock-rate-to-decrease-by-43-in-july
- 2026-07-21 — A primary SEC filing confirms **Grayscale Worldcoin ETF** filed Form S-1 on July 20 for a trust designed to hold WLD and seek Nasdaq listing under `GWLD`. Grayscale Investments Sponsors, LLC is sponsor, BitGo Bank & Trust is custodian, and the draft permits 10,000-share in-kind WLD or cash creation/redemption baskets. This is a real potential US market-access catalyst, but it is **not approved or effective**: trading requires Nasdaq confirmation and WLD eligibility under Rule 5711(d)(iv), the sponsor-fee percentage and seed terms remain blank, and no launch date is disclosed. Source: https://www.sec.gov/Archives/edgar/data/2145351/000119312526308957/ck0002145351-20260720.htm
- 2026-07-20 — Dedicated verification closed the WIP-1008 weak-signal row as **confirmed at the specification level only**. A fresh clone of the canonical World Chain repository contains merge commit `f43ad2ef` and the 268-line WIP, but the document itself still carries `status: Draft`, leaves `MIN_STAKE` and the predeploy address TBD, and says final parameters must be fixed before Review. Repository-wide searches found `StakeManager`, subblock committee, certificate-window and slashing constants only in the WIP/spec—not runtime contracts, node code or a validator sidecar. No official World/Foundation X endorsement, testnet, audit, governance activation or release was found. The design claim is resolved; implementation remains an ordinary open question, not an unverified rumor. Sources: https://github.com/worldcoin/world-chain/commit/f43ad2efdb65f57b749ab0ec158a4d8fcec6f6d4, https://github.com/worldcoin/world-chain/blob/main/wips/wip-1008.md and https://github.com/worldcoin/world-chain/pull/850
...
|---|---|---|---|---|---|---|
| Grayscale Worldcoin ETF / proposed Nasdaq `GWLD` | Confirmed S-1 filing / upcoming only if effective and listing conditions are met | Primary SEC Form S-1 filed 2026-07-20: https://www.sec.gov/Archives/edgar/data/2145351/000119312526308957/ck0002145351-20260720.htm. SEC submissions feed: https://data.sec.gov/submissions/CIK0002145351.json. | Filing submitted 2026-07-20; no amendment/effectiveness notice as of 2026-07-23; Nasdaq eligibility/approval and launch date unknown | If approved and launched, gives US brokerage/institutional accounts regulated spot exposure through a trust holding WLD, with 10,000-share creation/redemption baskets permitted in-kind with WLD or in cash. | Could deepen liquidity and create primary-market WLD flows; rejection, delay, thin AP participation or sponsor WLD sales for fees can limit the effect. | Event-driven only: reopen on a new SEC accession/effectiveness notice, Nasdaq eligibility/listing confirmation or official Grayscale launch/fee/AP artifact; then track AUM/flows and WLD creations/redemptions. |
| WIP-1008 WLD-staked subblocks and unsafe-head BFT | Confirmed merged Draft specification / implementation absent | World Chain merged the documentation-only Core standards-track proposal: https://github.com/worldcoin/world-chain/pull/850 and https://github.com/worldcoin/world-chain/commit/f43ad2efdb65f57b749ab0ec158a4d8fcec6f6d4. The WIP defines the validator overlay but still says `status: Draft`, leaves stake/address parameters TBD and has no matching runtime contract/node/sidecar implementation in the canonical repository. | Spec merged 2026-07-15; no implementation, governance or activation schedule as of 2026-07-20 | Confirms native WLD staking/validator economics as a real protocol design, not a live token utility. | If implemented, WLD gains productive utility and World Chain reduces single-sequencer censorship/reorg risk; validator concentration, reward funding and slashing design add governance and market-structure risks. | Monitor as an open implementation question: Foundation endorsement, Review/Final status, code/contracts, parameters, audits, testnet, governance and activation. |
...
| World Chain multi-proof validity verifier and proof-system hardening | Confirmed merged prior work; PR #909 stale/unshipped amid design pivot | Official GitHub merged an SP1 validity-proof verifier and removed an unused Nitro aggregation path: https://github.com/worldcoin/world-chain/pull/842 and https://github.com/worldcoin/world-chain/pull/845. PR #909 remains open at `806c2dd`: https://github.com/worldcoin/world-chain/pull/909. Draft OP-native successor work: https://github.com/worldcoin/world-chain/pull/916 | Prior changes merged 2026-07-13; #909 still unmerged/unversioned as of 2026-07-26 | Adds verifier diversity and removes a sensitive dead path; #909's fail-closed creation path has branch-level tests but no integrated proposer/bindings. | The OP-native pivot may supersede #909 while preserving optimistic creation without an initial proof; no external audit or deployment proves either follow-up live. | Event-driven: reopen on a merged successor that settles proof-at-creation semantics, updates proposer/bindings, passes CI/audit and publishes a deployed contract/code version. |
...
| WLD unlock rate decreases by 43% | Confirmed / completed | World Foundation schedule: https://x.com/worldcoinfnd/status/2079972684260147258 and https://world.org/blog/foundational-topics/tokenomics-milestone-wld-unlock-rate-to-decrease-by-43-in-july. Direct Community-contract verification: https://etherscan.io/address/0x1770bd8186AAd27Df9B050D65f86CF2cdC92C296 and https://etherscan.io/address/0xaEE0360b73B5D01dad134f234d3a93adc1680e57. | Completed 2026-07-24; linear daily unlocks continue with no cliff | Aggregate scheduled unlocks fell about `5.1M`→`2.9M WLD/day`; Community `3.2M`→`1.6M` and TFH investor/team `1.9M`→`1.3M`. Direct calls reproduce `1,596,715.33 WLD/day` for the new Community tranche. | Lower incremental supply can reduce market overhang, but unlocked is not identical to released, circulating or sold supply and OTC/treasury behavior still matters. | Track releases from the Community beneficiary, TFH/Foundation wallets, circulating-supply methodology, OTC sales and bridge/exchange flows; reopen the schedule itself only on a contract or allocation change. |
...
| https://www.sec.gov/Archives/edgar/data/2145351/000119312526308957/ck0002145351-20260720.htm | Primary Form S-1 for the proposed Grayscale Worldcoin ETF / Nasdaq `GWLD`; use for amendments, conditions, fees and risk disclosures. |
...
## Open questions
- How much of the newly unlocked Community and TFH investor/team entitlement is actually released, bridged, transferred to exchanges or counted as circulating supply, and which labeled beneficiary/wallet routes support that reconciliation?
- Verify whether World Chain's SP1 validity verifier is deployed/active, what audits cover the multi-proof system and whether the removed Nitro aggregation-signing path was ever callable in production. PR #909's recurring check closed stale on 2026-07-26; reopen only on a merged #909/successor with settled initial-proof semantics, proposer bindings, audit/CI and a versioned deployment.
...
- Track the Grayscale Worldcoin ETF S-1 through amendments/effectiveness and Nasdaq eligibility/listing confirmation; verify sponsor fee, seed terms, authorized participants, launch, AUM/flows and actual WLD creation/redemption activity before treating `GWLD` as live market access.

## Unverified Watch Items

| Date seen | Claim | Source | Source type | Credibility | Status | Why it matters | Next check |
|---|---|---|---|---|---|---|---|
| 2026-07-23; resolved 2026-07-26 | World Chain may make proof-game creation fail closed by requiring explicit L1-origin metadata and a valid initial proof; invalid/empty proofs would revert atomically. | https://github.com/worldcoin/world-chain/pull/909; competing draft: https://github.com/worldcoin/world-chain/pull/916 | Official GitHub implementation PR | High | Stale / unmerged and potentially superseded | #909 has one approval and passing branch tests but remains unmerged, unaudited and undeployed; canonical proposer bindings still use the old call. Draft #916 pivots to stock OP contracts and explicitly preserves optimistic creation without an initial proof. | Resolved (`carried_from: watchlist-scan-20260723T131204Z`): remove from the autonomous queue. Reopen only on a merged successor with proposer/binding integration, clear proof-at-creation semantics, audit/CI and a versioned deployment. |
| 2026-07-13; advanced 2026-07-15; resolved 2026-07-20 | WIP-1008 may add a WLD-staked validator overlay, protocol-guaranteed subblocks, BFT attestations, slashing, and validator fee/reward flows to World Chain. | https://github.com/worldcoin/world-chain/pull/850; merge: https://github.com/worldcoin/world-chain/commit/f43ad2efdb65f57b749ab0ec158a4d8fcec6f6d4; spec: https://github.com/worldcoin/world-chain/blob/main/wips/wip-1008.md | Official GitHub specification PR | High | Confirmed / closed at specification level; not implemented | The merged canonical WIP confirms the design, but it remains Draft, has TBD stake/predeploy parameters and exists only in spec files; no runtime contracts, node/sidecar code, audit, testnet, governance activation or official Foundation endorsement was found. | Resolved 2026-07-20 (`carried_from: scan-20260713T213409Z`): do not carry the design claim as unverified. Track implementation separately through the existing catalyst/open question and reopen only when code, contracts, parameters, audits, testnet or activation artifacts appear. |
