...
|---|---|---|---|---|---|---|
| Upbit and Bithumb Korean spot-market listings | Confirmed / completed and live | Announcements: https://x.com/Official_Upbit/status/2076900004313333964, https://www.upbit.com/service_center/notice?id=1824506959&view=share, https://x.com/DeriveXYZ/status/2076905813915074792, https://x.com/BithumbOfficial/status/2076908264701440110 and https://feed.bithumb.com/notice/1654034. Public APIs confirmed live tickers/order books for all four announced markets at 15:50 UTC: https://api.upbit.com/v1/ticker?markets=KRW-DRV,BTC-DRV,USDT-DRV and https://api.bithumb.com/v1/ticker?markets=KRW-DRV | Live 2026-07-14; initial API check showed about `₩65.76B` Upbit plus `₩3.58B` Bithumb DRV/KRW 24-hour turnover | Adds KRW, BTC and USDT CEX access and materially broadens DRV distribution beyond onchain/Hyperliquid liquidity. | Korean spot access can increase liquidity, arbitrage and holder turnover; it can also amplify volatility and bridge/deposit concentration risk if supported networks or withdrawals are constrained. | Verify supported deposit network/contracts, deposit/withdrawal reliability, BTC/USDT depth and price convergence, and whether KRW turnover/liquidity persist after listing-day attention. |
| Derive v3 / “infinite payoff factory” rollout | Tentative / CEO says close | CEO Nick Forster said Derive v3 is close and will let traders, builders and integrators create programmable payoffs for yield, hedging or speculation on any asset; he later teased that Derive v3 will solve vaults soon after criticizing covered-call vault fees: https://x.com/nickforster/status/2071522847223074871 and https://x.com/nickforster/status/2074897534200295660 | Near-term / exact launch date TBD | Could expand Derive from listed crypto options/perps into a programmable payoff platform with more integrator flow. | If shipped with liquidity and developer integrations, DRV fee/buyback inputs can diversify beyond BTC/ETH/HYPE and the venue can own more onchain structured-products surface area. | Watch official v3 release notes, vault docs/API changes, fee/risk mechanics, new payoff builders, RWA market launches, OI/fee lift, and whether buybacks reflect incremental revenue. |
...
| Protocol-fee buyback program | Confirmed / ongoing | Official buyback posts; latest Weekly Buyback #73 purchased 187,362 DRV at a $0.10 average price, cumulative Derive DAO buybacks reached 25,896,205 DRV, and posts continue to cite 35% of protocol fees allocated to DRV buybacks: https://x.com/DeriveXYZ/status/2072123109663265061. Direct metrics show seven-day fees at `$70,935` `as of 2026-07-15`, down `25.13%` from the prior scan and `48.44%` from July 6: https://api.llama.fi/summary/fees/derive?dataType=dailyFees | Weekly / ongoing; current fee contraction under review | Converts protocol revenue into open-market DRV demand. | Sustained organic fees can make DRV one of the cleaner revenue-linked DeFi tokens; a persistent fee contraction would mechanically reduce buyback capacity even if the 35% allocation is unchanged. | Monitor weekly buyback amount, average buy price, cumulative DRV bought, revenue source quality, options OI/volume, adapter coverage and whether seven-day fees recover. |
...
| Institutional/RFQ / external options-data rails | Tentative / watch | Official Derive website/docs for institutional-style trading UX, plus the Halcyon Waters Cayø Largo integration feeding BTC/ETH/HYPE market data into ORIA: https://www.derive.xyz/, https://docs.derive.xyz/, and https://x.com/DeriveXYZ/status/2076773740797686243 | Data integration live as of 2026-07-13; institutional order-flow roadmap unknown | Can distribute Derive market data into external intelligence workflows and potentially bring larger or more informed flow than a retail-only venue. | Repeat API/data integrations could make Derive a market-data primitive as well as an execution venue, but DRV relevance requires measurable users, attributed volume, fees or data revenue. | Track ORIA users/use cases, API/commercial terms, attributed BTC/ETH/HYPE flow, further data/RFQ/custody integrations, fees and buyback follow-through. |
...
- Which DRV network/contracts do Upbit and Bithumb support for deposits, are withdrawals reliable, do the thin BTC/USDT books converge, and does the strong initial KRW turnover/liquidity persist after listing day?
