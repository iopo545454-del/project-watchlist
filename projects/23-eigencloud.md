...
| Darkbloom distributed private inference and Gemma 4 MTP | Confirmed / public alpha; signed v0.7.12 artifact published, broad rollout and MTP still unverified | Darkbloom repo/README, merged MTP and tool-enforcement PRs, and release: https://github.com/Layr-Labs/d-inference, https://github.com/Layr-Labs/d-inference/pull/547, https://github.com/Layr-Labs/d-inference/pull/561 and https://github.com/Layr-Labs/d-inference/releases/tag/v0.7.12 | Public alpha ongoing; v0.7.12 published 2026-07-22; coordinator/broad-provider adoption and MTP activation unknown | Adds OpenAI/Anthropic-compatible private inference on idle Macs; v0.7.12 ships inference-time Gemma tool constraints and hybrid-cache fixes, while MTP could improve throughput by the PR's reported 7.7%–22.8% on selected M5 batches. | Better reliability/latency can attract paid workloads and providers, but issuer screenshots do not separate paid usage and the alpha still has no proven EIGEN route. | Verify v0.7.12 coordinator/broad-provider adoption and post-fix errors, MTP activation, paid share of `~3B` daily tokens, provider revenue/retention, platform-fee policy and EIGEN economics. |
...
| Darkbloom provider quality and throughput | Tests whether idle-Mac supply is usable, private and cost-competitive | Public attestation endpoint, signed releases, benchmark reports and provider telemetry | partial | v0.7.12 is signed/notarized and includes inference-time tool enforcement plus hybrid-cache fixes; coordinator/broad-provider rollout and post-fix error rate remain unknown. MTP remains a separate activation gate. |
...
| Darkbloom source/releases | GitHub API / `Layr-Labs/d-inference` | tested_ok | Merged/open PRs, signed releases, code and benchmark claims | Verify v0.7.12 coordinator/broad-provider adoption and post-fix error rate; track MTP activation and stable aggregate production telemetry. |
...
|---|---|---|---|---|---|---|---|
| 2026-07-16; advanced 2026-07-23 | Darkbloom's PR #548 reported 23,134 Gemma tool-template 500s—42.4% of Gemma tool terminal attempts in a 24-hour production window—with retries reaching 17 attempts and zero eventual successes for that class; signed v0.7.12 now includes PR #561's inference-time grammar enforcement plus capability-gated/fail-closed routing. | https://github.com/Layr-Labs/d-inference/pull/548; enforcement PR: https://github.com/Layr-Labs/d-inference/pull/561; signed release: https://github.com/Layr-Labs/d-inference/releases/tag/v0.7.12 | Official GitHub PR / production telemetry | High | Partially supported — PR #561 is merged and v0.7.12 is signed/notarized, but coordinator/broad-provider adoption and post-fix error rates remain unverified | This is a quantified live-product reliability failure that can waste fleet capacity, break tool-using agents and unfairly penalize healthy providers. | Verify v0.7.12 coordinator/provider adoption and broad rollout, then measure post-fix error rate, failed-user impact and provider-payout effects. |
...
- When does signed v0.7.12 reach coordinator/provider canary and broad production, and what are the resulting Gemma tool error rate, paid share of the reported `~3B` daily tokens, customer concentration, provider quality/revenue, model mix and EIGEN economics? When does MTP activate separately?
