...
- 2026-07-20 — Dedicated verification resolved the Yanez/Bitsec security-detail check as **stale at the technical-disclosure level**. The only primary description remains Yanez's quote that Bitsec found a “very important vulnerability,” delayed an unnamed release, and continued monitoring; no affected component, repository, report, severity, patch, retest, production-exposure statement or incident record appears on Yanez's official site, Bitsec's public docs/code surfaces or the named posts. That is not evidence of an exploit. Alternate primary checks did confirm that the YanezYID client is now live as version 1.0 on Apple (released July 15) and Google Play (updated July 17), while Yanez's official publications name Syklo and Nexartis as integration/commercial partners. None of those artifacts identifies the vulnerable component or proves SN54 revenue-to-alpha conversion. Close the undifferentiated vulnerability hunt; reopen only for a report, code/patch, incident or explicit exposure statement, and track client usage/revenue conversion separately. Sources: https://x.com/yanez__ai/status/2077070879985701136, https://apps.apple.com/us/app/yanezyid/id6784028862, https://play.google.com/store/apps/details?id=ai.yanez.yid, https://www.yanez.ai/post/closing-the-trust-gap-in-web3-settlement and https://www.yanez.ai/post/nexartis-and-yanez-ai-partner-to-verify-human-and-ai-agent-activity-across-digital-transactions
- 2026-07-14 — Official Yanez AI / SN54 disclosed that Bitsec found a **“very important vulnerability”** in Yanez code, causing an unspecified release to be delayed until the team fixed the issue; Yanez says Bitsec now provides ongoing code monitoring. No vulnerability class, affected component, severity report, repository, patch, dates, production-exposure statement, user/fund impact, or delayed-release identifier was published. Treat this as a positive pre-release review signal and an unresolved security-disclosure check—not evidence of an exploit or proof that production was exposed. Source: https://x.com/yanez__ai/status/2077070879985701136
...
- Native token: `TAO`.
- Core design: subnets compete for emissions by providing machine intelligence services such as inference, training, data, agents, search, compute, and specialized ML tasks.
...
- Jacob Steeves / `@const_reborn` — co-founder, visible philosophical/technical voice.
- Ala Shaabana / `@shibshib89` — co-founder.
- Etienne — President of Opentensor Foundation, referenced in ecosystem posts.
- Broader ecosystem: subnet founders, validators, miners, analytics teams, and funds.

## Investors
- Bittensor emphasizes permissionless emissions and validator/subnet economics more than traditional VC backing.
- Ecosystem capital includes Bittensor-native funds/accelerators and subnet investors.
- Notable ecosystem participants/accounts:
  - Unsupervised Capital / `@UnsupervisedCap`
  - Bitstarter / `@bitstarterai`
  - Latent Holdings / `@latentholdings`
  - Numerous subnet-specific backers.
...
- Explorer/analytics: https://taostats.io/
- Subnet market data: https://taomarketcap.com/
- Subnet analytics: https://subnetradar.com/

## Onchain/data resources
- TAO price, market cap, staking ratio, validator APY.
- Subnet emissions and emission share changes.
- Alpha-token prices, liquidity, market caps, unlock/halving schedules.
- Validator trust / VTrust, delegation flows, weight-setting behavior.
- Subnet registration burns and deregistrations.
- Governance proposals and runtime upgrades.
- Revenue claims from top subnets vs pure-emission dependence.
...
| https://apps.apple.com/us/app/yanezyid/id6784028862 | Official YanezYID iOS distribution; version/release metadata and product description. |
| https://play.google.com/store/apps/details?id=ai.yanez.yid | Official YanezYID Android distribution; current availability and update metadata. |
...
|---|---|---|---|---|---|---|
| Yanez / SN54 Bitsec pre-release security review | Confirmed high-level disclosure / technical follow-up stale | Official Yanez says Bitsec found a “very important vulnerability,” the release was delayed, the issue was addressed and Bitsec now monitors the code: https://x.com/yanez__ai/status/2077070879985701136. No report/code/patch/exposure artifact was found on Yanez or Bitsec public surfaces by the 2026-07-20 verification. | Historical pre-release event; technical follow-up closed 2026-07-20 | Shows external review changed the release process, but the affected component and severity cannot be independently assessed. | It should not be treated as an exploit or production incident without a component, code, transaction, affected user or incident disclosure. | Closed as stale. Reopen only for a public report, repository/patch, incident record, retest or explicit production/client/biometric/fund exposure statement. |
| Yanez AI / SN54 Proof-of-Humanhood revenue-to-alpha loop | Confirmed announcement; client apps live / conversion pending | Revenue-to-alpha announcement: https://x.com/yanez__ai/status/2075695559097401400. YanezYID is live on Apple and Google Play: https://apps.apple.com/us/app/yanezyid/id6784028862 and https://play.google.com/store/apps/details?id=ai.yanez.yid. Official Yanez publications name Syklo and Nexartis integrations: https://www.yanez.ai/post/closing-the-trust-gap-in-web3-settlement and https://www.yanez.ai/post/nexartis-and-yanez-ai-partner-to-verify-human-and-ai-agent-activity-across-digital-transactions | Product apps live July 15-17, 2026; revenue-conversion activation date unknown | Advances the product from pending app-store availability to public client software and named partner surfaces. | Paid partner usage converted into alpha could demonstrate external subnet demand; app availability alone does not prove revenue, registry growth or token conversion. | Verify production/paid Syklo and Nexartis usage, registry growth, conversion/retention contracts and wallets, gross revenue, buy frequency, incentive details and the meaning of “20% never sold.” |
...
| Crowdloans for subnet funding | Confirmed / docs-backed | Official docs describe crowdloans for funding subnet registration or extrinsics and sharing emissions by contribution: https://docs.learnbittensor.org/subnets/crowdloans | Docs last edited June 2026 | Lowers upfront capital burden for subnet creators and distributes exposure to new subnets. | Could increase subnet formation and speculative alpha markets; also raises quality-control risk. | Watch crowdloan usage, failed/successful raises, contributor protections, and subnet post-launch emissions. |
| Dynamic TAO governance/mainnet foundation | Confirmed / official posts | OpenTensor announced dTAO testnet, governance passage, and first mainnet blocks: https://x.com/i/status/1877771083484410181, https://x.com/opentensor/status/1888291457124966571, and https://x.com/opentensor/status/1890879222173835269 | Testnet January 2025; vote/mainnet February 2025 | Makes subnet-specific alpha markets central to TAO emissions and staking decisions. | Sustained alpha-market activity can make TAO more of an index into subnet performance. | Watch alpha liquidity, subnet price discovery, validator behavior, and follow-on emissions reforms. |

## Open questions
- Bittensor is not one product; it is an incentive layer for many subnet businesses.
- TAO valuation increasingly depends on subnet quality, alpha-token dynamics, and real external demand.
- Avoid evaluating only TAO spot price; subnet emissions, alpha performance, and validator behavior are critical.
- Do live YanezYID use and the named Syklo/Nexartis integrations produce paid verifications, registry growth and onchain SN54-alpha conversion, and what contract/wallet enforces the retained 20%?

---

## Watch triggers
- Major protocol upgrade or dTAO parameter change.
- Sharp emission rotation among top subnets.
- Large validator stake movement or VTrust degradation.
- Security issue in Subtensor, wallets, staking, bridges, or subnet code.
- Regulatory action targeting TAO, validators, or AI/compute marketplaces.
- Network congestion, chain halt, or validator/miner coordination failure.
- Subnet revenue narratives diverging from on-chain activity.
