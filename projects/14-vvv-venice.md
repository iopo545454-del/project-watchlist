...
| New frontier/coding/audio model launches in Venice | Confirmed / ongoing | Kimi K2.7 Code: https://x.com/AskVenice/status/2066634900652879949. Seed Audio 1.0 in Studio: https://x.com/AskVenice/status/2079627130556551470 and https://x.com/AskVenice/status/2079627132863381778 | Kimi live by 2026-06-15; Seed Audio live 2026-07-21 | Improves product utility across coding/agent workflows and controllable multilingual audio generation. | Broader model coverage can increase product/API demand and VVV staking/burn capacity if usage monetizes; another model surface without attributable usage is not token value capture. | Track docs/model list, API pricing, user uptake, model-attributed requests/revenue, and whether launches correlate with staking utilization or burns. |
...
| https://x.com/AskVenice/status/2079627130556551470 | Official Seed Audio 1.0 launch in Venice Studio; multilingual voice/SFX product-surface evidence. |
...
- 2026-07-21 — Venice made **BytePlus Seed Audio 1.0 live in Venice Studio**, adding controllable voice generation across **20+ languages**, timestamped prompting and prompts up to **`3,000` characters**; the official thread includes an in-product walkthrough and says the model can also produce sound effects and some music. This is a meaningful multimodal product-surface expansion after recent image/video/coding-model additions, but it disclosed no model-attributed requests, paid API availability, revenue, DIEM utilization, VVV staking demand or burn effect. Sources: https://x.com/AskVenice/status/2079627130556551470 and https://x.com/AskVenice/status/2079627132863381778
