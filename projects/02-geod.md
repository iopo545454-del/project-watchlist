...
| GEO-PULSE hardware commercialization | Confirmed / product-sales catalyst | Official post describes GEO-PULSE as ~$149 centimeter-level RTK for Android via Bluetooth, with restock/availability messaging: https://x.com/GEODNET/status/2065909299776209110; official in-motion outdoor field-test post: https://x.com/GEODNET/status/2075736468874523046 | Ongoing sales and field testing; latest test shown 2026-07-11 | Adds hardware revenue and consumer/fleet usage beyond miner emissions; latest post shows the device/reward loop being exercised outdoors in motion. | Hardware users can become demand-side consumers of GEODNET corrections, strengthening non-speculative revenue if field performance and adoption hold up. | Watch measured accuracy/route evidence, order volumes, reviews, active devices/app usage, returns/support issues, rewards paid, and whether revenue/burn dashboards reflect sales. |
...
- How much revenue or burn comes from recurring enterprise services versus one-off hardware sales?
