...
- **Current market data checked 2026-06-21/22:** Base Blockscout showed price about `$0.336597`, circulating market cap about `$15.0M`, volume about `$893k`, holders about `2,894`, total supply `500M POD`, implying about `$168M FDV` at that price.
...
## Thesis
- POD is a high-beta decentralized AI compute/data-generation option: if Dolphin proves real paid demand and automatic POD buybacks, the ~$15M circulating market cap screens low versus the scale of claimed GPU resources.
- On FDV, the bar is much higher: at ~$168M FDV, POD needs roughly `$8.4M-$16.8M` annualized revenue to screen at 20x-10x sales, or about `$23k-$46k/day`.
...
|---|---:|---|
| Price | ~$0.3366 | Base Blockscout token page |
| Circulating market cap | ~$15.0M | Blockscout field; circulating supply not separately returned |
| FDV | ~$168M | 500M total supply × Blockscout price |
| Revenue | Not available | No clean public revenue API found |
| Circ revenue needed at 10x sales | ~$1.5M/yr, ~$4.1k/day | Implied hurdle |
| FDV revenue needed at 10x sales | ~$16.8M/yr, ~$46k/day | Implied hurdle |
