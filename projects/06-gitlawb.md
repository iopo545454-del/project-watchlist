...
|---|---|---|---|---|---|---|
| Agent-native decentralized Git / Node v0.7.0 | Confirmed / completed release | Official release, agent guide and X article: https://github.com/Gitlawb/node/releases/tag/v0.7.0, https://explorer.gitlawb.com/docs/agents.md and https://x.com/gitlawb/status/2080115905728790992 | v0.7.0 live 2026-07-22; surfaced 2026-07-23 | Adds trusted-issuer certificate verification, Windows support, agent-first onboarding and provenance-backed multi-channel releases to the decentralized Git node/CLI. | A credible no-account signed-repository workflow can pull autonomous developers into GitLawb, but an issuer-run four-minute test is not retained adoption or token value capture. | Measure unique agents/repos, verified certificates, active nodes, repeat pushes, external evaluations, release installs and any fees/credits/GITLAWB route. |
| Protocol-revenue GITLAWB buyback-and-burn vault | Confirmed / live onchain; revenue-source attribution partial | Verified source and contract state: https://github.com/Gitlawb/contracts/blob/main/src/GitlawbBuybackVault.sol and https://base.blockscout.com/address/0xA05174583791bA7fecb37278A4d5c97C1E24Fc5f | Deployed 2026-07-17; verified 2026-07-22 | The owner-controlled vault was configured at `10,000` burn bps and had processed/burned `90,144,399.820766 GITLAWB` over `26` permissionless flushes, with zero forwarded and zero pending. | This is the first reproducible product-to-token execution path in the dossier, but the DEX swap is offchain and the source's “protocol revenue / x402 OpenGateway top-ups first” description is not an onchain proof of Ads/OpenGateway USDC revenue or margin. | Track wallet-mapped USDC inflows/swaps, burn cadence/notional versus supply, owner/burn-bps changes, source composition, provider costs and whether the pending FeeDistributor/staking stack passes external audit and deploys. |
...
| GITLAWB bought and burned | Directly measures executed token demand/removal | Verified `GitlawbBuybackVault` contract reads and transfers | tested_ok | `90,144,399.820766 GITLAWB` processed/burned across `26` flushes as of 2026-07-22. The vault verifies output tokens and burn execution, not which product generated the USDC or the offchain swap's gross/net economics. |
...
- The canonical Base token is now source-mapped as `0x5F980Dcfc4c0fa3911554cf5ab288ed0eb13DBa3`, and the buyback vault proves `90.144M` tokens burned. What are supply/owner/LP controls, LayerZero configuration, two-way delivery and the security/governance process for the owner-controlled burn ratio and future sink?
