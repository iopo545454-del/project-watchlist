...
last_updated: 2026-07-24T08:03:20Z
---
...
- 2026-07-24 — Dedicated verification closed the broad Tower fulfillment check as **stale pending a sale event**. The official page still says the waitlist is free and reservations are “opening soon”; total price is due before delivery, but no purchasable reservation, deposit/refund/warranty terms, ship date, delivered-unit count or owner earnings are published. The same page still states that the eight-RTX-5090 build is not monetizable through the permissionless subnet market and can only be contracted through a KYC tier. The live rental inventory API shows network inventory/prices but does not identify Tower-owned supply or realized Tower utilization. Reopen only when Targon publishes an order/terms/shipping artifact or an owner supplies verifiable delivery and earning records. Sources: https://targon.com/tower and https://api.targon.com/tha/v2/inventory?type=rental&gpu=true
- 2026-07-22 — Targon's live Tower page now exposes the hardware economics behind the waitlist: Tower Pro configurations run from **`$57,500`** for eight RTX 5090s to **`$305,900`** for eight H200s, with published H100/H200/RTX6000 hourly rates of `$2.00` / `$3.00` / `$1.30` and annual opex estimates of `$7,020` / `$7,560` / `$5,940` at 100% utilization. The entry 5090 build is explicitly **not monetizable on the permissionless subnet market** and can only be contracted through a KYC tier. A new TAO Protocol review surfaced the terms and correctly notes that ROI depends on utilization and prices holding; reservations remain “opening soon,” full payment is due before delivery, and no ship date or realized owner earnings are published. Sources: https://targon.com/tower and https://x.com/taoprotocolonly/status/2079786454754930741
...
| Tower Pro at-home confidential-compute hardware | Confirmed product/pricing; fulfillment verification stale until reservations open | Official configuration/economics and current waitlist page: https://targon.com/tower. Live network inventory API (not Tower-attributed): https://api.targon.com/tha/v2/inventory?type=rental&gpu=true. Independent ecosystem review: https://taoprotocol.org/targon-sn4-it-wants-to-sell-you-the-computer-not-rent-you-the-cloud/ | Free waitlist live; reservations still “opening soon”; no ship date, terms or delivered units as of 2026-07-24 | Offers owned eight-GPU TDX/confidential-compute systems from `$57,500` to `$305,900` with a marketed earning-mode path; the RTX 5090 configuration remains KYC-tier-only for monetization. | If delivered into real demand, Tower can expand SN4 supply and turn customers into providers; no owner ROI can be validated before orders, deliveries and Tower-attributed utilization exist. | Closed as stale 2026-07-24: reopen on a reservation/order artifact with payment/refund/warranty and shipping terms, or verifiable owner delivery/earnings records. Do not infer Tower economics from aggregate rental inventory. |
...
- Tower fulfillment check closed stale on 2026-07-24 while only a free waitlist exists. Reopen when reservations/orders expose payment/refund/warranty and ship terms or when owners provide verifiable delivery, utilization and earnings records; the RTX 5090 build remains KYC-tier-only for monetization.
