...
| Tower Pro at-home confidential-compute hardware | Confirmed product and pricing; reservations not yet open | Official configuration/economics page: https://targon.com/tower. Independent ecosystem review: https://taoprotocol.org/targon-sn4-it-wants-to-sell-you-the-computer-not-rent-you-the-cloud/ | Waitlist live; reservations “opening soon”; no ship date as of 2026-07-22 | Offers owned eight-GPU TDX/confidential-compute systems from `$57,500` to `$305,900` with an earning-mode path back to Targon supply. | If delivered into real demand, Tower can expand SN4 supply and turn customers into providers; high upfront cost, utilization dependence and the 5090 model's KYC-only monetization can sharply limit adoption and realized ROI. | Verify reservation opening, payment/refund/warranty terms, ship dates and delivered units; measure owner utilization, realized hourly rates/opex, permissionless eligibility, downtime and incremental SN4 buybacks. |
...
- When do Tower Pro reservations and shipments begin, how many units are delivered, and do realized utilization/earnings support the published payoff curves after opex, downtime and the 5090 build's KYC-only monetization constraint?
