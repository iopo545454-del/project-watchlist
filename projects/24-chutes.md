...
last_updated: 2026-07-23T08:59:01Z
---
...
| Confidential-inference verification and adoption | Tests whether Chutes' TEE route has independently checkable workload evidence and real demand | Chutes private-agent surface, dstack ACI attestation reports/source and partner-attributed traffic | partial | Gateway main now exposes and verifies the RTMR3-bound measured Compose preimage for supported upstreams including Chutes; reviewed source/image policy, deployed-report verification and Chutes-attributed usage remain unproven. |
...
## Open questions
- The public 7d mix through 2026-07-21 was `79.85%` paygo, `17.58%` subscriptions, `2.58%` private instances and `0%` in the explicit sponsored field. The known Harvard opt-in 25% discount ends July 24; what other discounts/free quotas or incentive costs sit outside the revenue table, and does post-closure revenue per token change?
...
- Which integrations route meaningful recurring volume to Chutes? dstack routing and measured-Compose verification are source-confirmed, but live Chutes deployment evidence and dstack/ChronoSeek-attributed volume are not public.
