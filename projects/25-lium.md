...
last_updated: 2026-07-10T03:22:55Z
---
...
## Thesis
- Lium is the smaller GPU-marketplace beta in the decentralized neo-cloud basket: lower value than Chutes/Targon and visible high-end GPU supply, but less clean demand/revenue proof.
...
| Alpha market cap / subnet value | ~$42.9M | Taostats, converted from TAO |
| Liquidity / pool value | ~$49.5M | Taostats, converted from TAO |
| External revenue proxy | ~$530k / 90d | Third-party/community/analytics claim; needs verification |
| Annualized external revenue proxy | ~$2.15M | 90d run-rate |
| Burn proxy | ~50 TAO/day | Community/analytics proxy; needs wallet/dashboard verification |
| Annualized burn proxy | ~$4.17M | Uses TAO ~$228 |
| Value / external revenue proxy | ~20.0x | Lower confidence |
| Value / burn proxy | ~10.3x | Lower confidence |
...
- Taoflute / Lium dashboard: external revenue, GPU supply, utilization, burn/buyback metrics.
- GPU inventory by class: B200, H200, H100, B300, RTX Pro 6000 Blackwell.
- Wallets/contracts used for burns or alpha accumulation.

## Docs/blogs
- Official Lium docs/blog still need to be pinned once verified.
...
|---|---|---|---|---|---|---|
| Kraken SN51 trading live | Confirmed / completed listing | Kraken listings announced SN51 live for trading: https://x.com/krakenlistings/status/2075221836749738365; official Lium follow-up: https://x.com/lium_io/status/2075365366134456625 | 2026-07-09 | Adds centralized exchange access for SN51 alpha exposure after the earlier roadmap entry. | Broader access can widen participation in the GPU-marketplace/buyback thesis and raise scrutiny on revenue/burn verification. | Watch pairs, spot liquidity, deposits/withdrawals, Kraken availability by region, and whether buyback/burn cadence or credit demand changes after listing. |
...
- What wallet(s) execute the 50 TAO/day burn/buyback proxy, and are those flows durable?
- What is live paid GPU utilization by class?
