...
| Protocol/client activation | Tracks v86, post-quantum keys, dynamic resharding and SPICE | nearcore releases, governance and RPC | manual_only / source available | Release publication is not mainnet activation; verify protocol version, validator adoption and production behavior. |
...
## Watch triggers
- Protocol v86 vote/result and mainnet activation; validator/client problems or security disclosures.
