...
| NEAR Intents as cross-chain / agent-market money rail | Confirmed / official product-growth signal | Official NEAR said Intents routes across 30+ chains and 180+ assets and is expanding from RWAs/perps into the NEAR Agent Market; Illia later highlighted EURe in NEAR accounts via RHEA/NEAR Intents and Monerium: https://x.com/NEARProtocol/status/2070528852036600030 and https://x.com/ilblackdragon/status/2072446177711177789 | Ongoing/live; EURe/RHEA signal noted 2026-07-01 | Broadens the settlement surface for swaps, RWAs/perps, FX/payments and agent transactions. | More chains/assets/agent-market/FX flows can feed the revenue dashboard and strengthen NEAR’s chain-abstraction/neo-banking thesis if usage is real. | Watch routed volume, monetizable cross-chain market share, Agent Market transaction examples, EURe/Monerium jurisdictions and fees, fee capture, and partner integrations. |
