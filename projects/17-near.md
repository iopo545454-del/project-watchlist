...
| Confidential Intents general availability, TVL milestone, and NEAR@3.33 incentive | Confirmed / product live + live incentive | Official NEAR announced Confidential Intents general availability through the 1Click Swap API and cited >$1.5B ZEC settled across NEAR Intents, 42% near.com volume using Confidential Mode shortly after launch, and daily confidential TVL >$30M; NEAR DevHub said Confidential Intents are live on mainnet for AI agents with skill/markdown wallet registration, confidential swaps, private agent transfers, gasless cross-chain execution, TEE-held keys, spending limits, and whitelists; earlier posts describe NEAR@3.33 tied to confidential pools reaching $70M TVL: https://x.com/NEARProtocol/status/2074515816670781812, https://x.com/NEARDevHub/status/2074586616425816502, https://www.near.org/blog/announcing-general-availability-of-confidential-intents, https://www.near.org/blog/how-confidential-intents-works, https://x.com/NEARProtocol/status/2067735351947309431, https://x.com/NEARProtocol/status/2069400493374189959, and https://x.com/NEARProtocol/status/2074582972204711969 | GA announced 2026-07-07; DevHub mainnet-agent follow-up 2026-07-07; incentive snapshot when confidential pools reach $70M TVL | Lets builders/dApps add privacy-preserving execution via a `confidential` 1Click parameter and gives agent builders a mainnet confidential transaction path while the incentive continues to bootstrap confidential balances/swaps. | Wider developer/agent access can turn private settlement from near.com-only UX into partner/distribution flow; fee/revenue impact depends on sustained volume, partner adoption, and whether confidential TVL remains after incentives. | Watch integrations using the confidential API, DevHub skill templates/docs, confidential-pool TVL vs $70M trigger, swap count, claim rules, post-incentive retention, abuse filtering, and revenue-dashboard capture. |
| Revenue dashboard and three-part capture mechanics | Confirmed / live KPI | Official revenue dashboard plus NEAR thread breaking capture into front-end fees, quote improvement and B2B partner revenue share: https://revenue.near.org/, https://x.com/NEARProtocol/status/2070500258597986371, https://x.com/NEARProtocol/status/2070500261479543099, and earlier context https://x.com/NEARProtocol/status/2069108737466368417 | Live; 30D capture rates cited 2026-06-26 | Converts Intents/protocol usage into measurable revenue after partner payouts, with explicit categories traders can track. | If revenue approaches or exceeds emissions, NEAR’s tokenomics narrative shifts from inflationary L1 to usage-funded buybacks; decomposed capture metrics make it easier to spot mix shift or partner-margin compression. | Watch revenue vs emissions, partner payout share, buyback execution, exact dashboard API values, and whether revenue is organic vs campaign-driven. |
