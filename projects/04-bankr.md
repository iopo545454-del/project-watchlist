...
last_updated: 2026-07-12T02:08:10Z
---
...
|---|---|---|---|---|---|---|
| Robinhood Chain execution / user-created public skills / agent dev surface | Confirmed | Official Bankr bot posted the two-week dev update covering live Robinhood Chain tokenized-stock trading and a sandboxed skill catalog: https://x.com/bankrbot/status/2073779586274615788; a July 9 dev update added advanced orders, price-impact protection, airdrops and Glidepath: https://x.com/bankrbot/status/2075203322764812411; on July 12 the core builder and bot showed live no-repo skill creation, review/public-catalogue publishing, and a one-prompt Robinhood stock-autopilot skill: https://x.com/0xDeployer/status/2076110506298118353 and https://x.com/bankrbot/status/2076124359509614955 | Live / advanced 2026-07-12 | Broadens Bankr from packaged skills and execution into user-created, reviewable and publicly distributable agent workflows, including capital-management automation on Robinhood Chain. | Could make Bankr a distribution layer for reusable financial agents if external creation, installs and paid usage compound; BNKR relevance remains indirect until fees, Club utility, or reward rules are explicit. | Verify skill review/security controls, creator/install/active-user counts, autonomous execution limits, Robinhood Chain portfolio usage/volume, fees, and whether any flow accrues to BNKR/Bankr Club. |
...
| Reward Season 2 — 250M BNKR pool and composite scoring | Confirmed / upcoming distribution; mechanics incomplete | Core builder announced a 250,000,000 BNKR pool and listed builder, deployer, BNKR, ecosystem-coins, volume, social, LLM-usage, OG, PnL, referral, and NFT score inputs: https://x.com/0xDeployer/status/2075708868420841954 and https://x.com/0xDeployer/status/2075990899813962208; official Bankr bot said BNKR score uses Base balance and detailed participation requires Bankr Club: https://x.com/bankrbot/status/2075991713261461658 | Pool announced 2026-07-10/11; snapshot, claim and distribution dates unknown | Commits 250M BNKR (0.25% of 100B supply; roughly $90K at the 2026-07-11 Blockscout price check) to a multi-factor community incentive program and makes BNKR holdings plus Bankr usage explicit score inputs. | Could pull activity into Club, trading, deploying, LLM usage and ecosystem tokens, but opaque weights may invite farming and the pool is small relative to supply/market cap. | Verify score weights, whether staking is distinct from wallet balance, snapshot/claim dates, eligibility, anti-sybil controls, funding wallet/claim contract, vesting, final recipient count and post-reward retention. |
...
| 2026-06-22 | Bankr bot may route users toward a dead/outdated BNKR staking contract because its toolset/knowledge base lacks the current v2 staking contract; bot acknowledged this as a real problem and requested the live address/ABI. | https://x.com/i/status/2069117276113305975; verification context: https://x.com/bankrbot/status/2074242273882333210, https://x.com/bankrbot/status/2074233865699557405, https://x.com/bankrbot/status/2074242694717878406, https://x.com/bankrbot/status/2074234539816484875, and https://x.com/bankrbot/status/2074233036447900074 | High | Partially supported / needs contract-level confirmation | Bankr bot later described the current staking system as a vault with deposit, 18-hour cooldown, and 3-day withdrawal window; it also reaffirmed canonical `$BNKR` token address `0x22af33fe49fd1fa80c7149773dde5890d3c76f3b` and flagged a queried alternate address as not Bankr-launched. This reduces the unresolved-tooling risk but still leaves the exact staking vault contract/docs source to verify. | Verify official BNKR staking docs/vault address, Basescan contract state, and live bot behavior before marking confirmed; monitor for further stale-address warnings or user-fund complaints. |
